...
async def create_properties(
    ...
    """
    property_location_details = PropertyLocationDetails.parse_raw(property_location_details)
    ...
    await property_collection2.update_one({"_id": result.inserted_id}, {"$set": {"id": property_id}})
